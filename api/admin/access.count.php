<?php
    ...
    */
    ...
    if ($type=='set') {
        //获取country
        $country = get_post_para('country',true);
        //获取
        $province = get_post_para('province',true);
        //获取
    ...
    if ($type=='set') {
        //添加记录
        $sql_insert = "insert into admin_count (country,province,city,nowurl,fromurl,dates) values('$country','$province','$city','$nowurl','$fromurl',now())";
    ...
    elseif ($type=='get') {
        ...
        if ($sort=='list') {
            ...
            while($row=mysqli_fetch_array($query))
            {
                ...
                $indexArray["country"] = $row['country'];//国家
                $indexArray["province"] = $row['province'];//省份
