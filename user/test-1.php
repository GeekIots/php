...
<body style="margin-top: 65px;">
    ...
    <div class="main fly-home-main">
      <!-- 发帖列表模板 -->
      <!-- <script id="home_moduel_2" type="text/html"> -->
            ...
            <ul class="jie-row">
              {{#  layui.each(d.list, function(index, item){ }}
                <li>
                  ...
                  <a href="/jie/1.html" class="jie-title">{{item.title}}</a>
                  <i>{{item.dates}}</i>
      ...
      <!-- </script> -->
      <!-- 建立视图。用于呈现模板渲染结果。 -->
      <!-- <div id="home_view_2"></div> -->
      
      <!-- 回帖列表模板 -->
      <!-- <script id="home_moduel_3" type="text/html"> -->
...
<script>
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      user_d = res;
      // //渲染用户信息数据
      // var getTpl = home_moduel_1.innerHTML;
      // var view = document.getElementById('home_view_1');
