          ...
          <ul class="layui-nav layui-nav-tree"  lay-filter="test">
            <li class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                <dd class="layui-bg-green"><a href="javascript:;">用户列表</a></dd>
              </dl>
            </li>
            <li class="layui-nav-item">
            ...
            <li class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd><a href="/admin/blog.list.php">文章列表</a></dd>
              </dl>
            </li>
            <li class="layui-nav-item">
...
table.render({
  ...
  ,{field: 'datetime', title: '注册时间', width: 120, sort: true}
  ,{field: 'level', title: '级别', width: 80, sort: true}
  ,{field: 'phonenumber', title: '手机', width: 120, sort: true}
  ,{field: 'qq_openid', title: 'QQ绑定', width: 120, sort: true}
  ,{field: 'value', title: '积分', width: 80, sort: true}
...
table.on('tool(tabetool)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
  ...
  if(layEvent === 'detail'){ //查看
      console.log(data);
      window.location.href="/user/home.php?userid="+data.userid; 
    ...
    layer.confirm('真的删除行么', function(index){
      ...
      //向服务端发送删除指令
      $.ajax({
        url: "/api/admin/user.delete.php?userid="+data.userid,
        async: true, //同步
