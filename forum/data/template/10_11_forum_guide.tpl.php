...
0
|| checktplrefresh('./template/test999_game_16080201/forum/guide.htm', './template/default/forum/guide_list_row.htm', 1522286475, '11', './data/template/10_11_forum_guide.tpl.php', './template/test999_game_16080201', 'forum/guide')
...
<?php echo $multipage;?>
<a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav" id="t9_guide_post"><img src="<?php echo IMGDIR;?>/pn_post.png" alt="发新帖" /></a>
</div>
<?php } ?>
