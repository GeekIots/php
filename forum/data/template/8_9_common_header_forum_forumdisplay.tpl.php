...
0
|| checktplrefresh('./template/test999_city_12042101/common/header.htm', './template/default/common/header_common.htm', 1522221693, '9', './data/template/8_9_common_header_forum_forumdisplay.tpl.php', './template/test999_city_12042101', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/test999_city_12042101/common/header.htm', './template/default/common/header_qmenu.htm', 1522221693, '9', './data/template/8_9_common_header_forum_forumdisplay.tpl.php', './template/test999_city_12042101', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/test999_city_12042101/common/header.htm', './template/test999_city_12042101/common/pubsearchform.htm', 1522221693, '9', './data/template/8_9_common_header_forum_forumdisplay.tpl.php', './template/test999_city_12042101', 'common/header_forum_forumdisplay')
;?>
...
<base href="<?php echo $_G['siteurl'];?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_8_common.css?<?php echo VERHASH;?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_8_forum_forumdisplay.css?<?php echo VERHASH;?>" /><?php if($_G['uid'] && isset($_G['cookie']['extstyle']) && strpos($_G['cookie']['extstyle'], TPLDIR) !== false) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['cookie']['extstyle'];?>/style.css" /><?php } elseif($_G['style']['defaultextstyle']) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['style']['defaultextstyle'];?>/style.css" /><?php } ?><script type="text/javascript">var STYLEID = '<?php echo STYLEID;?>', STATICURL = '<?php echo STATICURL;?>', IMGDIR = '<?php echo IMGDIR;?>', VERHASH = '<?php echo VERHASH;?>', charset = '<?php echo CHARSET;?>', discuz_uid = '<?php echo $_G['uid'];?>', cookiepre = '<?php echo $_G['config']['cookie']['cookiepre'];?>', cookiedomain = '<?php echo $_G['config']['cookie']['cookiedomain'];?>', cookiepath = '<?php echo $_G['config']['cookie']['cookiepath'];?>', showusercard = '<?php echo $_G['setting']['showusercard'];?>', attackevasive = '<?php echo $_G['config']['security']['attackevasive'];?>', disallowfloat = '<?php echo $_G['setting']['disallowfloat'];?>', creditnotice = '<?php if($_G['setting']['creditnotice']) { ?><?php echo $_G['setting']['creditnames'];?><?php } ?>', defaultstyle = '<?php echo $_G['style']['defaultextstyle'];?>', REPORTURL = '<?php echo $_G['currenturl_encode'];?>', SITEURL = '<?php echo $_G['siteurl'];?>', JSPATH = '<?php echo $_G['setting']['jspath'];?>', CSSPATH = '<?php echo $_G['setting']['csspath'];?>', DYNAMICURL = '<?php echo $_G['dynamicurl'];?>';</script>
<script src="<?php echo $_G['setting']['jspath'];?>common.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php if(empty($_GET['diy'])) { $_GET['diy'] = '';?><?php } if(!isset($topic)) { $topic = array();?><?php } ?>
<link rel="shortcut icon" href="<?php echo $_G['style']['styleimgdir'];?>/favicon.ico">
<link rel="Bookmark" href="<?php echo $_G['style']['styleimgdir'];?>/favicon.ico">
...
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/jquery.js" type="text/javascript" type="text/javascript"></script>
...
</div><?php } ?><?php echo adshow("headerbanner/wp a_h");?><div id="toptb" class="cl">
<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_top'])) echo $_G['setting']['pluginhooks']['global_cpnav_top'];?>
...
<?php if($_G['setting']['topnavs']['0'] || $_G['setting']['topnavs']['1']) { if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><i></i><?php echo $nav['code'];?><?php } } if(is_array($_G['setting']['topnavs']['1'])) foreach($_G['setting']['topnavs']['1'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } } ?>
</div>
...
<?php if($_G['uid']) { ?>
<span id="t9_um_btn">
<span title="访问我的空间"><?php echo $_G['member']['username'];?></span>
<?php if($_G['member']['newpm'] || $_G['member']['newprompt_num']['follower'] || $_G['member']['newprompt_num']['follow'] || $_G['member']['newprompt']) { ?>
<span class="t9_notice"><i class="t9_icon" title="提醒"></i></span>
<?php } ?><?php echo avatar($_G[uid],small);?></span>
<?php } else { ?>
<span id="t9_um_btn" class="t9_btn_login">登录</span>
<span class="t9_btn_reg"><a href="member.php?mod=<?php echo $_G['setting']['regname'];?>">注册</a></span>
<?php } ?>
</div>
</div>
...
<?php if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">切换风格</a><?php } if(empty($_G['disabledwidthauto']) && $_G['setting']['switchwidthauto']) { ?>
...
<?php } ?>
<div class="t9_search"><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
<button type="submit" name="searchsubmit" id="scbar_btn" sc="1" class="pn pnc" value="true"><span class="t9_btn_2"></span></button>
</form>
</div>
...
<div id="t9_um_area" class="t9_um_area"><?php include template('common/header_userstatus'); ?></div>
</div>
</div>
</div>
...
<?php } ?>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/t9_click.js" type="text/javascript"></script>
<script language="javascript" >var jq = jQuery.noConflict();</script>
<div id="wp" class="wp"><?php echo adshow("subnavbanner/a_mu");?>