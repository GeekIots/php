...
0
|| checktplrefresh('./template/test999_game_16080201/forum/viewthread.htm', './template/test999_game_16080201/forum/viewthread_node.htm', 1522223032, 'diy', './data/template/10_diy_forum_viewthread.tpl.php', './template/test999_game_16080201', 'forum/viewthread')
|| checktplrefresh('./template/test999_game_16080201/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1522223032, 'diy', './data/template/10_diy_forum_viewthread.tpl.php', './template/test999_game_16080201', 'forum/viewthread')
|| checktplrefresh('./template/test999_game_16080201/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1522223032, 'diy', './data/template/10_diy_forum_viewthread.tpl.php', './template/test999_game_16080201', 'forum/viewthread')
|| checktplrefresh('./template/test999_game_16080201/forum/viewthread.htm', './template/default/common/seditor.htm', 1522223032, 'diy', './data/template/10_diy_forum_viewthread.tpl.php', './template/test999_game_16080201', 'forum/viewthread')
|| checktplrefresh('./template/test999_game_16080201/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1522223032, 'diy', './data/template/10_diy_forum_viewthread.tpl.php', './template/test999_game_16080201', 'forum/viewthread')
|| checktplrefresh('./template/test999_game_16080201/forum/viewthread.htm', './template/default/common/upload.htm', 1522223032, 'diy', './data/template/10_diy_forum_viewthread.tpl.php', './template/test999_game_16080201', 'forum/viewthread')
|| checktplrefresh('./template/test999_game_16080201/forum/viewthread.htm', './template/default/common/seccheck.htm', 1522223032, 'diy', './data/template/10_diy_forum_viewthread.tpl.php', './template/test999_game_16080201', 'forum/viewthread')
...
$postshowavatars = !($_G['setting']['bannedmessages'] & 2 && ($post['memberstatus'] == '-1' || ($post['authorid'] && !$post['username']) || ($post['groupid'] == 4 || $post['groupid'] == 5) || ($post['status'] & 1)));?><div class="t9_node_n"><?php
$authorverifys = <<<EOF
...
<?php if($modmenu['thread']) { ?>
<div class="xi2 mbm pbm bbs modmenu">
