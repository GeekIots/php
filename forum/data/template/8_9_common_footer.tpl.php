...
<div class="wp">
<div id="frt" class="z">
<p><img src="<?php echo $_G['style']['styleimgdir'];?>/logo_70.png" /></p>
<p class="t9_app">
<?php if($_G['setting']['site_qq']) { ?><a href="#" target="_blank" title="QQ" class="t9_icon t9_qq"></a><?php } ?>

<a href="#" target="_blank" title="Weibo" class="t9_icon t9_weibo"></a>

<a href="#" target="_blank" title="Wechat" class="t9_icon t9_weixin"></a>
</p>
<p><?php if(!empty($_G['setting']['pluginhooks']['global_footerlink'])) echo $_G['setting']['pluginhooks']['global_footerlink'];?></p>
<?php if($_G['setting']['statcode']) { ?><p style="display:none;"><?php echo $_G['setting']['statcode'];?></p><?php } ?>
</div>
<div id="flk">
<div class="t9_part t9_part1">
<h2>网站导航</h2><?php if(is_array($_G['setting']['footernavs'])) foreach($_G['setting']['footernavs'] as $nav) { if($nav['available'] && ($nav['type'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1)) ||
!$nav['type'] && ($nav['id'] == 'stat' && $_G['group']['allowstatdata'] || $nav['id'] == 'report' && $_G['uid'] || $nav['id'] == 'archiver' || $nav['id'] == 'mobile' || $nav['id'] == 'darkroom'))) { ?><p><?php echo $nav['code'];?></p><?php } } ?>

</div>
<div class="t9_part t9_part2">
<h2>帮助与支持</h2>
<p><a href="#" target="_blank">9测 Discuz! 模板</a></p>
<p><a href="#" target="_blank">9测 Discuz! 模板</a></p>
<p><a href="#" target="_blank">9测 Discuz! 模板</a></p>
<p><a href="#" target="_blank">9测 Discuz! 模板</a></p>
<p><a href="#" target="_blank">9测 Discuz! 模板</a></p>
</div>
<div class="t9_part t9_part3">
<h2>联系我们</h2>
<p><a href="#" target="_blank">9测模板</a></p>
<p><a href="#" target="_blank">9测模板</a></p>
<p><a href="#" target="_blank">9测模板</a></p>
</div>
...
<div class="t9_ft_bottom">
<div class="wp">
<p>Powered by <a href="http://www.discuz.net" target="_blank">Discuz!</a> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?> &copy; 2001-2013 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a> Designed by 999test.cn & <a href="<?php echo $_G['setting']['siteurl'];?>" target="_blank"><?php echo $_G['setting']['sitename'];?></a>
<a href="http://www.miitbeian.gov.cn/" target="_blank"><?php echo $_G['setting']['icp'];?></a>
