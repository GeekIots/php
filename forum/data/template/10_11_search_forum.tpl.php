...
0
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/header.htm', 1522229070, '11', './data/template/10_11_search_forum.tpl.php', './template/test999_game_16080201', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/pubsearch.htm', 1522229070, '11', './data/template/10_11_search_forum.tpl.php', './template/test999_game_16080201', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/thread_list.htm', 1522229070, '11', './data/template/10_11_search_forum.tpl.php', './template/test999_game_16080201', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/footer.htm', 1522229070, '11', './data/template/10_11_search_forum.tpl.php', './template/test999_game_16080201', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/common/header_common.htm', 1522229070, '11', './data/template/10_11_search_forum.tpl.php', './template/test999_game_16080201', 'search/forum')
;?>
