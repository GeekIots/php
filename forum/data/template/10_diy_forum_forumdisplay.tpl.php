...
0
|| checktplrefresh('./template/test999_game_16080201/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1522223019, 'diy', './data/template/10_diy_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'forum/forumdisplay')
|| checktplrefresh('./template/test999_game_16080201/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1522223019, 'diy', './data/template/10_diy_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'forum/forumdisplay')
|| checktplrefresh('./template/test999_game_16080201/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1522223019, 'diy', './data/template/10_diy_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'forum/forumdisplay')
|| checktplrefresh('./template/test999_game_16080201/forum/forumdisplay.htm', './template/test999_game_16080201/forum/forumdisplay_list.htm', 1522223019, 'diy', './data/template/10_diy_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'forum/forumdisplay')
|| checktplrefresh('./template/test999_game_16080201/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1522223019, 'diy', './data/template/10_diy_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'forum/forumdisplay')
|| checktplrefresh('./template/test999_game_16080201/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1522223019, 'diy', './data/template/10_diy_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'forum/forumdisplay')
|| checktplrefresh('./template/test999_game_16080201/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1522223019, 'diy', './data/template/10_diy_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'forum/forumdisplay')
...
<div class="boardnav">
<div id="ct" class="wp cl<?php if($_G['forum']['allowside']) { ?> ct2<?php } ?>"<?php if($leftside && empty($_G['forum']['picstyle'])) { ?> style="margin-left:<?php echo $_G['leftsidewidth_mwidth'];?>px"<?php } ?>>
<?php if($leftside && empty($_G['forum']['picstyle'])) { ?>
...
<?php if(empty($_G['forum']['sortmode'])) { ?><div id="threadlist" class="tl bm bmw" style="<?php if($_G['uid']) { ?> position: relative;<?php } if($_G['forum']['picstyle']) { ?> border:none; background: none;<?php } ?>">
...
<div class="bm_c"<?php if($_G['forum']['picstyle']) { ?> style="padding:0;"<?php } ?>>
...
<div class="t9_forumlist_ann"<?php if($_G['forum']['picstyle']) { ?> style="margin-bottom: 20px"<?php } ?>>
...
<?php } else { ?>
<div class="t9_nopic">本帖暂未生成封面图片</div>
<?php } ?>
