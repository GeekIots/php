...
<div class="t9_ft_bg"><div class="t9_n_1"></div></div>
...
<div id="frt">
<p>Powered by <strong><a href="http://www.discuz.net" target="_blank">Discuz!</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?> Designed by 999test.cn & <a href="<?php echo $_G['setting']['siteurl'];?>" target="_blank"><?php echo $_G['setting']['sitename'];?></a></p>
...
<?php } if($_G['basescript'] == 'portal' && !$_G['mod'] || $_G['basescript'] == 'portal' && $_G['mod'] == 'list' || $_G['basescript'] == 'portal' && $_G['mod'] == 'view' || $_G['basescript'] == 'forum' && !$_G['mod'] || $_G['basescript'] == 'forum' && $_G['mod'] == 'forumdisplay' || $_G['basescript'] == 'forum' && $_G['mod'] == 'viewthread') { ?>
<script type="text/javascript">
...
width: 180,
height: 180,
text: "<?php echo $_G['setting']['siteurl'];?>"
});
</script>
