...
0
|| checktplrefresh('./template/test999_game_16080201/common/header.htm', './template/default/common/header_common.htm', 1522223019, '11', './data/template/10_11_common_header_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/test999_game_16080201/common/header.htm', './template/default/common/header_qmenu.htm', 1522223019, '11', './data/template/10_11_common_header_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/test999_game_16080201/common/header.htm', './template/test999_game_16080201/common/pubsearchform.htm', 1522223019, '11', './data/template/10_11_common_header_forum_forumdisplay.tpl.php', './template/test999_game_16080201', 'common/header_forum_forumdisplay')
;?>
...
<?php } ?>
<link rel="stylesheet" type="text/css" href="<?php echo $_G['style']['styleimgdir'];?>/css/style.css" />
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/jquery.js" type="text/javascript"></script>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/jquery.qrcode.min.js" type="text/javascript"></script>
...
<div id="t9_container">
<div id="qrcode_menu" style="display: none;"><p>扫到手机上看</p></div><?php echo adshow("headerbanner/wp a_h");?><div id="hd" class="t9_hd">
<div class="wp">
...
<div id="nv">
<div class="wp">
<a href="javascript:;" id="qrcode" onMouseOver="delayShow(this, function() {showMenu({'ctrlid':'qrcode','pos':'34!','ctrlclass':'a','duration':2})});">手机上看</a>
...
<div id="wp" class="wp">
<div class="t9_x_scbar"><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
